...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 grid min-h-screen place-items-center overflow-y-auto bg-black/50 px-4 py-8",
        className,
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-serif text-xl leading-none font-semibold tracking-wider",
        className,
      )}
      {...props}
    />
