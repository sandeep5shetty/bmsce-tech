...
const Home = (props: Props) => {
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M11.1175 2.82207C11.3645 2.61407 11.6771 2.5 12 2.5C12.3229 2.5 12.6355 2.61407 12.8825 2.82207L20.5 9.23684V15.5C20.5 18.3284 20.5 19.7426 19.6213 20.6213C18.796 21.4466 17.4983 21.4968 15 21.4998V16.5C15 15.0858 15 14.3787 14.5607 13.9393C14.1213 13.5 13.4142 13.5 12 13.5C10.5858 13.5 9.87868 13.5 9.43934 13.9393C9 14.3787 9 15.0858 9 16.5V21.4998C6.50173 21.4968 5.20398 21.4466 4.37868 20.6213C3.5 19.7426 3.5 18.3284 3.5 15.5V9.23684L11.1175 2.82207Z"
        fill="currentColor"
      ></path>
      <path
