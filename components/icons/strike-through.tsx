...
const StrikeThrough = (props: Props) => {
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M6 16.3333C6 18.9107 8.68629 21 12 21C15.3137 21 18 18.9107 18 16.3333C18 13.9404 16.9693 12.5782 14.9079 12H9.09212C7.03071 12.5782 6 13.9404 6 16.3333Z"
        fill="currentColor"
      ></path>
      <path
        d="M4 12H20"
