...
const NoImage = (props: Props) => {
  return (
    ...
    >
      ...
      <path
        opacity="0.4"
        d="M4.25275 20.302C5.6554 21.5 7.77026 21.5 12 21.5C14.3303 21.5 16.0187 21.5 17.2997 21.2997L7.5 11.5L2.59601 16.404C2.72269 17.921 3.0165 18.9494 3.69796 19.7472C3.86808 19.9464 4.05358 20.1319 4.25275 20.302Z"
        fill="currentColor"
      ></path>
      <path
