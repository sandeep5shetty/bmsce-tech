  ...
  return (
    <>
      <ConfirmActionDialog
        ...
        description="This will permanently remove the event and its questions. This action cannot be undone."
...
function StatusBadge({ status }: { status: "draft" | "published" }) {
  ...
  return (
    <Badge
      variant="secondary"
      className="relative shrink-0 bg-white/95 text-[10px] font-semibold text-gray-700 shadow-sm"
    >
      Draft
    </Badge>
  );
